...
import { useColorMode, AvatarGroup, IconButton, Text, Flex, Spinner, Button } from "@chakra-ui/react";
import { parseTableData, toProperCase } from '@/utils/stringUtils';
...
const RigCard = ({tableName, infoClick, table}) => {
