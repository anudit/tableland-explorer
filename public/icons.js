...
export const PlusIcon = createIcon({
    ...
    viewBox: '0 0 24 24',
    path: (
        <path fill="currentColor" d="M11 11v-11h1v11h11v1h-11v11h-1v-11h-11v-1h11z"/>
    )
})
...
export const ImportIcon = createIcon({
    ...
    viewBox: '0 0 24 24',
    path: (
        <path fill="currentColor" d="M8 11h-6v10h20v-10h-6v-2h8v14h-24v-14h8v2zm5 2h4l-5 6-5-6h4v-12h2v12z"/>
    )
})
...
export const OpenaiIcon = createIcon({
    ...
    viewBox: '0 0 24 24',
    path: (
        <path fill="currentColor" d="M22.3 9.8a6 6 0 0 0-.5-4.9A6 6 0 0 0 15.3 2 6 6 0 0 0 5 4.2 6 6 0 0 0 1 7a6 6 0 0 0 .7 7 6 6 0 0 0 .5 5 6 6 0 0 0 6.6 3 6 6 0 0 0 4.5 2 6 6 0 0 0 5.7-4.2 6 6 0 0 0 4-3 6 6 0 0 0-.7-7zm-9 12.6a4.5 4.5 0 0 1-3-1h.2l4.8-2.8a.8.8 0 0 0 .4-.7V11l2 1.2V18a4.5 4.5 0 0 1-4.4 4.5zm-9.7-4.1a4.5 4.5 0 0 1-.5-3h.1L8 18.2a.8.8 0 0 0 .8 0l5.8-3.3V17l-4.9 3a4.5 4.5 0 0 1-6.1-1.6zM2.3 7.9a4.5 4.5 0 0 1 2.4-2v5.7a.8.8 0 0 0 .4.7l5.8 3.3-2 1.2-5-2.8a4.5 4.5 0 0 1-1.5-6zM19 11.8l-5.8-3.4 2-1.2 5 2.8a4.5 4.5 0 0 1-.8 8.1v-5.7a.8.8 0 0 0-.4-.6zm2-3v-.2L16 6a.8.8 0 0 0-.8 0L9.4 9.2V7l4.9-3a4.5 4.5 0 0 1 6.6 4.7zm-12.6 4-2-1.1V6a4.5 4.5 0 0 1 7.3-3.5l-.1.1-4.8 2.8a.8.8 0 0 0-.4.6zm1.1-2.3L12 9l2.6 1.5v3L12 15l-2.6-1.5z"/>
    )
})
...
export const SparklesIcon = createIcon({
    ...
    viewBox: '0 0 24 24',
    path: (
        <path fill="currentColor" d="m11 7 5 5 5-5-5-5-5 5zm7 7 3 3 3-3-3-3-3 3zm-6 5 2 3 3-2-3-3-2 3zm-6-8 2 2-2 2-2-2 2-2zm0-4c-1 3-3 5-6 6 3 1 5 3 6 6 1-3 3-5 6-6-3-1-5-3-6-6z"/>
    )
})
